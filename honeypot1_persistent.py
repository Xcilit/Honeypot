...
ips_file = 'allowed_ips.json'


def load_data():
    global users, allowed_ips
    try:
    ...
    try:
        with open(ips_file, 'r') as f:
            allowed_ips = set(json.load(f))
    except FileNotFoundError:
        allowed_ips = {'192.168.200.210'}
...
allowed_ips = set()  # Загружается позже
attempts = {}
